...
class GridDrawer {
    ...
    private final com.prettybyte.hexagons.HexagonMap map;
    ...
    void draw(Group root) {
        Collection<com.prettybyte.hexagons.Hexagon> hexagons = map.getAllHexagons();
        for (com.prettybyte.hexagons.Hexagon hexagon : hexagons) {
            hexagon.addEventFilter(MouseEvent.MOUSE_CLICKED,
                    new EventHandler<MouseEvent>() {
                        @Override
                        public void handle(MouseEvent me) {
                            com.prettybyte.hexagons.GridPosition pos = ((Hexagon) me.getSource()).position;
                            try {
     ...
     */
    static com.prettybyte.hexagons.GridPosition pixelToPosition(int x, int y, int hexagonHeight, int xPadding, int yPadding) {
        x = x - xPadding;
        y = y - yPadding;
        ...
        return (com.prettybyte.hexagons.GridPosition.hexRound(q, r));
    }
