...
public class Hexagon extends Polygon {
    ...
    private com.prettybyte.hexagons.HexagonMap map;
     ...
     */
    public com.prettybyte.hexagons.HexagonMap.Direction getDirectionTo(Hexagon target) {
     ...
     * @param direction
     * @return neighbour
     * @throws com.prettybyte.hexagons.NoHexagonFoundException
     */
    public Hexagon getNeighbour(com.prettybyte.hexagons.HexagonMap.Direction direction) throws com.prettybyte.hexagons.NoHexagonFoundException {
        checkMap();
     ...
     * @throws com.prettybyte.hexagons.NoPathFoundException if there exists no path between start and the goal
     */
    public ArrayList<Hexagon> getPathTo(Hexagon destination, IPathInfoSupplier pathInfoSupplier) throws com.prettybyte.hexagons.NoPathFoundException {
        checkMap();
     ...
     * @param destination the target Hexagon
     * @return an array of Hexagons, sorted so that the first step comes first.
     * @throws com.prettybyte.hexagons.NoPathFoundException if there exists no path between start and the
     *                              goal
     */
    public ArrayList<Hexagon> getPathTo(Hexagon destination) throws NoPathFoundException {
        checkMap();
        return Calculations.getPathBetween(this, destination, new com.prettybyte.hexagons.HexagonMap.DefaultPathInfoSupplier());
    }
