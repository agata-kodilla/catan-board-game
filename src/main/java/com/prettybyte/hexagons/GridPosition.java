...
class GridPosition implements Cloneable, Serializable {
     ...
     */
    public GridPosition getNeighborPosition(com.prettybyte.hexagons.HexagonMap.Direction direction) {
    ...
    ArrayList<GridPosition> getPositionsOnCircleEdge(int radius) {
        ...
        if (radius == 0) {
            ...
            for (int i = 0; i < radius; i++) {
                h = h.getNeighborPosition(com.prettybyte.hexagons.HexagonMap.Direction.SOUTHWEST);
            }
            int counter = 0;
            for (int i = 0; i < 6; i++) {
    ...
    private static int getNumberFromDirection(com.prettybyte.hexagons.HexagonMap.Direction direction) {
        switch (direction) {
            case NORTHWEST:
                return 0;
            case NORTHEAST:
    ...
    static com.prettybyte.hexagons.HexagonMap.Direction getDirectionFromNumber(int i) {
        switch (i) {
            case 0:
                return com.prettybyte.hexagons.HexagonMap.Direction.NORTHWEST;
            case 1:
                return com.prettybyte.hexagons.HexagonMap.Direction.NORTHEAST;
            case 2:
                return com.prettybyte.hexagons.HexagonMap.Direction.EAST;
            case 3:
                return com.prettybyte.hexagons.HexagonMap.Direction.SOUTHEAST;
            case 4:
                return com.prettybyte.hexagons.HexagonMap.Direction.SOUTHWEST;
            case 5:
                return com.prettybyte.hexagons.HexagonMap.Direction.WEST;
        }
        throw new RuntimeException();
    }
